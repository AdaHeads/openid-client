...
package body ASF.Sessions is
   ...
   --  ------------------------------
   function Get_Principal (Sess : in Session) return Security.Permissions.Principal_Access is
   begin
      if Sess.Impl = null or else not Sess.Impl.Is_Active then
         raise No_Session;
      end if;
   ...
   procedure Free is
     new Ada.Unchecked_Deallocation (Object => Security.Permissions.Principal'Class,
                                     Name   => Security.Permissions.Principal_Access);
